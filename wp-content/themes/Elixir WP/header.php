...
<head>
    ...
    <script>
     ...
     ga('create', 'UA-71713050-1', 'auto');
     ga('send', 'pageview');
    </script>
    <!-- END Google Analytics -->
</head>
<body <?php body_class($jellythemes['color']); ?>>
    <div id="mask">
        <div class="loader">
    ...
    <header id="header" role="banner">
        <div class="jt_row container">
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand mini" href="<?php echo site_url(); ?>/#home-slider"><img src="<?php echo esc_url($jellythemes['logo']['url']); ?> " alt="<?php echo strip_tags($jellythemes['blogname']); ?>"></a>
                    <a class="navbar-brand mini darker" href="<?php echo site_url(); ?>/#home-slider"><img src="<?php echo esc_url($jellythemes['logo']['url']); ?> " alt="<?php echo strip_tags($jellythemes['blogname']); ?>"></a>
            </div>
